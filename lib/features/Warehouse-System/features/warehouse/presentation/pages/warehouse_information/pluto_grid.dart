...
class _PlutoGridWidgetState extends State<CustomGrid1> {
  ...
  void initState() {
    ...
    columns = [
      ...
      PlutoColumn(
        title: 'حقل اضافي 1 من بيانات الاصناف في العمليات ',
        field: 'group',
        type: PlutoColumnType.text(),
        textAlign: PlutoColumnTextAlign.center,
        titleTextAlign: PlutoColumnTextAlign.center,
      ...
      PlutoColumn(
        title: 'حقل اضافي 2 من بيانات الاصناف في العمليات ',
        field: 'group2',
        type: PlutoColumnType.text(),
        textAlign: PlutoColumnTextAlign.center,
        titleTextAlign: PlutoColumnTextAlign.center,
      ...
      PlutoColumn(
        title: 'الكمية الاستلام المتجاوزة التحويل',
        field: 'width10',
        type: PlutoColumnType.number(),
        textAlign: PlutoColumnTextAlign.center,
        titleTextAlign: PlutoColumnTextAlign.center,
    ...
    rows = List.generate(
      ...
      (index) => PlutoRow(
        cells: {
          ...
          'group2': PlutoCell(value: ''),
          'product_type': PlutoCell(value: ''),
          'expiry_date': PlutoCell(value: ''),
          'actions': PlutoCell(value: 'Delete'),
          'analytical_section': PlutoCell(value: ''),
          'analytical_section11': PlutoCell(value: ''),
          'analytical_section22': PlutoCell(value: ''),
          'analytical_section33': PlutoCell(value: ''),
          'analytical_section44': PlutoCell(value: ''),
          'analytical_section55': PlutoCell(value: ''),
          'analytical_section66': PlutoCell(value: ''),
          ...
          'analytical_section5': PlutoCell(value: ''),
          'analytical_section6': PlutoCell(value: ''),
          'analytical_section_description': PlutoCell(value: ''),
          'height': PlutoCell(value: ''),
          'width': PlutoCell(value: ''),
          'width1': PlutoCell(value: ''),
          'width2': PlutoCell(value: ''),
          'width3': PlutoCell(value: ''),
          'width4': PlutoCell(value: ''),
          'width5': PlutoCell(value: ''),
          'width6': PlutoCell(value: ''),
          'width7': PlutoCell(value: ''),
          'width8': PlutoCell(value: ''),
          'width9': PlutoCell(value: ''),
          'width10': PlutoCell(value: ''),
          'width11': PlutoCell(value: ''),
          'free_quantity': PlutoCell(value: ''),
          'free_quantity1': PlutoCell(value: ''),
          'free_quantity2': PlutoCell(value: ''),
          'free_quantity3': PlutoCell(value: ''),
