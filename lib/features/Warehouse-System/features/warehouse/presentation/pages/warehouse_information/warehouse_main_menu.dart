...
import 'package:onyx/core/responsive/home/pupupmenubutton.dart';

import 'List_butter.dart';
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const Text(
                                  "امر تحويل مخزون-جديد", // Arabic text
                                  style: TextStyle(
                              ...
                              children: [
                                const SizedBox(
                                    width:
                                        8), // Space between the icon and text
                                const Text(
                                  "تم استخدامه في استلام التحويل المخزني", // Arabic text
                                  style: TextStyle(
                              ...
                              children: [
                                const SizedBox(
                                    width:
                                        8), // Space between the icon and text
                                const Text(
                                  "تم استخدامه في مرجع التحويل المخزني", // Arabic text
                                  style: TextStyle(
                                    color: Colors.red, // Text color
                                    fontSize: 13, // Text size
                                  ),
